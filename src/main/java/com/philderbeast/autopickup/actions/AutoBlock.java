...
public class AutoBlock {
	public static final Map<Material, Material> convertTo = new HashMap<>();
	public static final Map<Material, Integer> convertNum = new HashMap<>();
	private static final HashMap<Material, Short> convertDurability = new HashMap<>();

	public static Map<Integer, ItemStack> addItem(Player p, ItemStack is) {
